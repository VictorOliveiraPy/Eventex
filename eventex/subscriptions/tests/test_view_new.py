...
class SubscriptionsNewPost(TestCase):  # Submisão do form
    def setUp(self):
    ...
    def test_send_subscribe_email(self):  # mail enviando
...
class SubscriptionsNewPostInvalid(TestCase):
    def setUp(self):
        self.resp = self.client.post(r('subscriptions:new'), {})  # Dados vazio, mostrar os erros
